	...
	public List<OxygenTank> produceOxygenForOrder(OxygenCategories requestedCategory, LocalDate requestDate) {
		...
		if (quantityToCover > 0) {
			...
			if (category == OxygenCategories.E) {
				...
				history.addCategoryProduction(requestDate, actualOxygenProduction.getCategory(), actualOxygenProduction.getNumberOfUnitsUsed() * producedTanks.size()); // TODO : Test this call
			}
