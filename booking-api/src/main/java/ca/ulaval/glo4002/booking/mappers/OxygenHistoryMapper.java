...
public class OxygenHistoryMapper {
	...
	public List<OxygenHistoryItemDto> toDto(OxygenHistory oxygenHistory) {
		...
		oxygenHistory.returnSortedListByDate().forEach(oxygenHistoryItem -> historyDto.add(mapper.toDto(oxygenHistoryItem)));
	 ...
	 * This logic is now in OxygenHistory and OxygenHistoryItem not sure if OxygenHistoryItem is needed
	 * */
