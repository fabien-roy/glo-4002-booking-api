...
public class OxygenCategoryBuilderTest {
	...
	public void buildById_shouldReturnCorrectOxygenCategory_whenCategoryIsE() {
		...
		validateOxygenCategory(oxygenCategory, OxygenConstants.Categories.E_ID, OxygenConstants.Categories.E_NAME,
	...
	public void buildById_shouldReturnCorrectOxygenCategory_whenCategoryIsB() {
		...
		validateOxygenCategory(oxygenCategory, OxygenConstants.Categories.B_ID, OxygenConstants.Categories.B_NAME,
	...
	public void buildById_shouldReturnCorrectOxygenCategory_whenCategoryIsA() {
		...
		validateOxygenCategory(oxygenCategory, OxygenConstants.Categories.A_ID, OxygenConstants.Categories.A_NAME,
