...
public class OxygenTankRepositoryContext {
	...
	private void setUpOxygenTanks() {
		oxygenTankA = new OxygenTankEntity(A_OXYGEN_ID, OxygenConstants.Categories.A_ID, A_DATE_BEFORE_FESTIVAL,
				A_DATE_AFTER_THE_OTHER_ONE);

		oxygenTankB = new OxygenTankEntity(B_OXYGEN_ID, OxygenConstants.Categories.B_ID, A_DATE_BEFORE_FESTIVAL,
				A_DATE_AFTER_THE_OTHER_ONE);

		oxygenTankE = new OxygenTankEntity(E_OXYGEN_ID, OxygenConstants.Categories.E_ID, A_DATE_BEFORE_FESTIVAL,
				A_DATE_AFTER_THE_OTHER_ONE);

		nonExistentOxygenTank = new OxygenTankEntity(NON_EXISTENT_OXYGEN_ID, OxygenConstants.Categories.A_ID,
				A_DATE_BEFORE_FESTIVAL, A_DATE_AFTER_THE_OTHER_ONE);
	}
