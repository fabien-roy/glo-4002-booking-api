...
public class PassEndToEndContext {
    ...
    private static final LocalDate A_VALID_PASS_DATE = FestivalConstants.Dates.START_DATE.plusDays(1L);
    private static final LocalDate ANOTHER_VALID_PASS_DATE = FestivalConstants.Dates.START_DATE.plusDays(2L);
    private static final Long A_VENDOR_ID = VendorConstants.TEAM_VENDOR_ID;
    private static final LocalDateTime A_VALID_ORDER_DATE = FestivalConstants.Dates.ORDER_START_DATE_TIME;
